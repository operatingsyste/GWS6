...
function checkForUpdates(){
  ...
  setTimeout(function(){
    ...
    var config = confirm('Update is available update name GWS 7');
    if (config){
      document.getElementById("h1").innerHTML = '<a href="https://operatingsyste.github.io/GWS7SETUP/upd.html" id="updCl"> Validating update packages </a>';
